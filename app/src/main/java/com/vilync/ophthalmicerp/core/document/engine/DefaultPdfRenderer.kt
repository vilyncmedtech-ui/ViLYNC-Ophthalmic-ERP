...
class DefaultPdfRenderer(
    ...
    /**
     * Physical rendering of a session into a PDF file using context for environmental properties.
     */
    fun renderSession(session: RenderSession, context: RenderContext, outputFile: File): PdfRenderResult {
        ...
        try {
            ...
            // PDF units are always points (72 DPI)
